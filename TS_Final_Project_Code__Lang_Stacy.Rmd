...
#plot a forecast of points
fore.aruma.wge(x=co2_total$CO2, phi=0, theta=c(-0.5532092), d=1, s=0, n.ahead=5, lastn=FALSE)
#20 years out
fore.aruma.wge(x=co2_total$CO2, phi=0, theta=c(-0.5532092), d=1, s=0, n.ahead=20, lastn=FALSE)
...
#R_W_ASE(co2_total$CO2, trainingSize=20, horizon=5, s=0, d=1, thetas=c(-0.5532092))
```
