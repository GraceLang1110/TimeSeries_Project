...
#ASE
mean((preds5$fcst$y1 - alldata$CO2[(length_all-n.ahead):length_all])^2) ##Getting an error here, not sure why, i was trying to use your length built in function so it's easier for 20 year
...
#Using all the data
set.seed(2)
fit.mlp = mlp(co2_all,reps = 50,comb="mean")
fit.mlp #MSE = 0.074
